        ...
        <div class="main_page">
            ...
            <!--Begin section -->
                ...
                <div class="content_section_text">
                    ...
                    <form method="post" action="save_topology.php">
                        <input type="submit" name="botao_save" value="SAVE TOPOLOGY">
                    </form>
                    ...
                    <script type="application/javascript">
                        $(document).ready(function(){
                            $('#botao_save').click(function(){
                                $.post('save_topology.php', { text: $("#history_area").val(), function(data){
                                    var result = <?php echo $_SESSION['result']; ?>
                                    $("#debug_area").val('Teste' . result);
                                    console.log(result);
                                }});
                            });         
                        });
                    ...
                    <script type="application/javascript">
                        $(document).ready(function(){
                            $('#botao_reset').click(function(){
                                $.post('reset.php', { text: $("#history_area").val(), function(data){
                                    $("#history_area").val('');
                                    console.log("Topology file reset.");
                                }});
                            });         
                        });
                    </script>
                    ...
                    <script type="application/javascript">
                        $(document).ready(function(){
                            $('#botao_batch').click(function(){
                                $.post('send_batch.php', { text: "sample text", function(data){
                                    console.log("Batch file created and sent.");
                                }});
                            });         
                        });
                    </script>
                    ...
                    <script type="application/javascript">
                        $(document).ready(function(){
                            $('#botao_done').click(function(){
                                $.post('send_done.php', { text: "sample text", function(data){
                                    console.log("Done file created and sent.");
                                }});
                            });         
                        });
                    </script>
