...
<html>
    ...
    <body>
        ...
        <div class="main_page">
            ...
            <tt>(Sponsored by UTFPR C&#226;mpus Apucarana)</tt>            
                        ...
                        $(document).ready(function(){
                            $('#botao_reset').click(function(){
                                $.post('reset.php', { 
                                    text: "0", function(){
                                        var tam = $("#history_area").val().trim().length;
                                        var result = "Error reseting topology. Empty history.";
                                        if ( tam > 0 ){
                                            result = "<?php echo $_SESSION['reset_result'];?>";
                                        } 
                                        $("#history_area").val('');
                                        $("#debug_area").val(result);
                                        console.log(result);
                        ...
                        $(document).ready(function(){
                            $('#botao_batch').click(function(){
                                $.post('send_batch.php', { text: "", function(){
                                    var tam = $("#history_area").val().trim().length;
                                    var result = "Error sending batch. Empty history.";
                                    if ( tam > 0 ){
